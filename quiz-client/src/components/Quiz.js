  ...
  return (
    qns.length !== 0
      ? <Card sx={{
        ...
        <Box>
          <LinearProgress variant='determinate' value={(qnIndex + 1) * 100 / 5}></LinearProgress>
        </Box>
        {qns[qnIndex].imageName != null
          ? <CardMedia component={"img"} image={BASE_URL + 'images/' + qns[qnIndex].imageName} sx={{width:'auto',m:'10px auto'}}></CardMedia>
          : null}
        <CardContent>
